...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getmonthyear(monthlyyear){
        this.pickingMonthly = monthlyyear
        return this.pickingMonthly
