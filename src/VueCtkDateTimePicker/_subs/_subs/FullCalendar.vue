<template>
  <div
    ...
    <div
      :style="{height: (monthDays.length + weekDay) > 35 }"
        ...
        <div
          ...
          <button
            ...
            class="datepicker-day align-center justify-content-center"/>
              ...
              <div class="datepicker-day-class">
                <span class="datepicker-day-class-text" @click="selectClass(day)">{{ scheduler }}</span>
              </div>
              <modal
...
<script>
  ...
  export default {
    ...
    props: {
      ...
      schedule: {type: String, default: String}
    },
    data () {
      return {
...
<style lang="scss" scoped>
  ...
  #FullCalendar.datepicker-container {
    width: 290px;
    padding: 0 5px;
    &.p-0 {
      padding: 0;
