        ...
        <div
          ...
          <div class="flex justify-content-between">
            <transition-group
              ...
              class="datepicker-date dots-text flex">
              <span
...
<script>
  ...
  import FullCalendar from './_subs/FullCalendar.vue'
  ...
  export default {
    ...
    methods: {
      ...
      getmonthyear(event){
        this.$parent.$emit('changMonth', this.monthyear)
      }
    }
  }
</script>
